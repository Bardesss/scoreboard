...
| **9** | [stats-panels-expansion.md](2026-04-23-stats-panels-expansion.md) | ready to execute | League stats + dashboard expansion + shared primitives + date filter + skeletons + charts + i18n sweep |
| **10a** | phase-10a-payments-mollie-stripe.md | not written (parked) | main spec §11 (Mollie, Stripe) — credit purchase flow, webhooks, ECB rates, VAT |
| **10b** | phase-10b-payments-bitcoin.md | not written (parked) | main spec §11 (Strike/Lightning) — Bitcoin credit purchase |
