...
| **5** | phase-5-polish.md | not written | main spec §14 (tax export), credits spec §7 (analytics), cron, final polish |
| **6** | phase-6-payments-mollie.md | not written | main spec §11 (Mollie, Stripe) — credit purchase flow, webhooks |
| **7** | phase-7-payments-bitcoin.md | not written | main spec §11 (Strike/Lightning) — Bitcoin credit purchase |
