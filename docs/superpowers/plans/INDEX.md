...
| **Display Name** | [2026-05-20-account-display-name.md](2026-05-20-account-display-name.md) | done | Account-level `User.displayName` used site-wide; one-way synced to the linked me-player |
| **Account Avatar** | [2026-05-20-account-avatar.md](2026-05-20-account-avatar.md) | ready to execute | Account avatar — colour + pictogram picker, synced to the me-player, shown site-wide |
