...
export default function MobileHeader() {
  return (
    <header className="lg:hidden fixed top-0 inset-x-0 z-40 h-14 flex items-center px-4" style={{ background: 'rgba(247,243,237,0.88)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', borderBottom: '1px solid rgba(245,166,35,0.1)' }}>
