...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <NextIntlClientProvider locale={locale} messages={messages}>
      ...
      <MobileHeader name={linkedPlayer?.name ?? user.email} email={user.email} credits={totalCredits} isAdmin={user.role === 'admin'} unreadCount={unreadCount} notifications={serializedNotifications} bannerOffset={isLow} />
      <main
